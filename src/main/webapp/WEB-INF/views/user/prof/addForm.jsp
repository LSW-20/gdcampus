		...
		<div class="main-content">
			<div class="page-content">
				...
				<div class="col-lg-12">
					<hr>
					<div class="mt-5">
						<form action="${contextPath}/user/prof/insert.do" method="post"
							class="was-validated">
							...
							<div class="row justify-content-md-center">
								<div class="col-md-6">
									<div class="form-group">
										<label>부서</label>
										<div class="select">
											<select class="custom-select" name="stDeptNo" id="deptNo">
							...
							<div class="mt-4 row d-flex justify-content-center">
								...
								<a class="btn btn-primary w-md mr-3" href="${contextPath }/user/prof/list.do">취소</a>
							</div>
						</form>
					</div>
				</div>
